...
int harp_product_apply_collocation_mask(harp_collocation_mask *collocation_mask, harp_product *product)
{
    ...
    else
    {
        ...
        {
            harp_set_error(HARP_ERROR_SCRIPT, "variable '%s' has %d dimensions (expected 1)", index->name,
        ...
        {
            harp_set_error(HARP_ERROR_SCRIPT, "dimension 0 of variable '%s' is of type '%s' (expected '%s')",
