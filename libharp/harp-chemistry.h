...
/* Make sure the list is sorted such that longer names come before the shorter ones (e.g. put NO before NO2) */
typedef enum harp_chemical_species_enum
{
    ...
    harp_chemical_species_CHF2Cl,
    harp_chemical_species_ClNO,
    harp_chemical_species_ClONO2,
    ...
    harp_chemical_species_OBrO,
    harp_chemical_species_OClO,
    harp_chemical_species_OCS,
