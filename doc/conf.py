# -*- coding: utf-8 -*-
#
# HARP documentation build configuration file, created by
...
project = u'HARP'
copyright = u'2015-2025 S[&]T, The Netherlands'
author = u'S&T'
...
latex_documents = [
  (master_doc, 'HARP.tex', u'HARP Documentation',
   u'S\\&T', 'manual'),
]
...
man_pages = [
    (master_doc, 'harp', u'HARP Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'HARP', u'HARP Documentation',
   author, 'HARP', 'Earth Observation data harmonization toolset',
   'Miscellaneous'),
]
